...
export type ResolversTypes = ResolversObject<{
  ...
  JiraAccount: ResolverTypeWrapper<JiraAccount>;
...
export type JiraAccountResolvers<ContextType = any, ParentType extends ResolversParentTypes['JiraAccount'] = ResolversParentTypes['JiraAccount']> = ResolversObject<{
  id: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
