...
export async function up(knex: Knex): Promise<void> {
  ...
  await knex.schema.createTable(
    ...
    (table: Knex.CreateTableBuilder): void => {
      ...
      table
        ...
        .notNullable()
        .defaultTo("now");
      table.timestamp("archived", { useTz: true }).nullable();
      table.timestamp("snoozed", { useTz: true }).nullable();
    },
  );
  ...
  await knex.schema.createTable(
    ...
    (table: Knex.CreateTableBuilder): void => {
      ...
      table.timestamp("due", { useTz: true }).nullable();
      table.timestamp("manualDue", { useTz: true }).nullable();
      table.timestamp("done", { useTz: true }).nullable();
      table.text("controller").notNullable();
    },
  );
  ...
  await knex.schema.createTable(
    ...
    (table: Knex.CreateTableBuilder): void => {
      ...
      table.text("pluginId").notNullable();
      table.boolean("hasTaskState").notNullable();
      table.timestamp("taskDone", { useTz: true }).nullable();
      table.timestamp("taskDue", { useTz: true }).nullable();
  ...
  await knex.schema.createTable(
    ...
    (table: Knex.CreateTableBuilder): void => {
      ...
      table.timestamp("present", { useTz: true }).nullable();
      table.timestamp("due", { useTz: true }).nullable();

      table
        .foreign(["pluginId", "itemId"])
