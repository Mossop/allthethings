...
const models: TsoaRoute.Models = {
    "Pick_GoogleAccountEntity.Exclude_keyofGoogleAccountEntity.userId-or-accessToken-or-refreshToken-or-expiry__": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"id":{"dataType":"string","required":true},"email":{"dataType":"string","required":true},"avatar":{"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}],"required":true}},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "Omit_GoogleAccountEntity.userId-or-accessToken-or-refreshToken-or-expiry_": {
        "dataType": "refAlias",
        "type": {"ref":"Pick_GoogleAccountEntity.Exclude_keyofGoogleAccountEntity.userId-or-accessToken-or-refreshToken-or-expiry__","validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    ...
    "Omit_GoogleMailSearchEntity.accountId_": {
        "dataType": "refAlias",
        "type": {"ref":"Pick_GoogleMailSearchEntity.Exclude_keyofGoogleMailSearchEntity.accountId__","validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "GoogleMailSearchState": {
        "dataType": "refAlias",
        "type": {"dataType":"intersection","subSchemas":[{"ref":"Omit_GoogleMailSearchEntity.accountId_"},{"dataType":"nestedObjectLiteral","nestedProperties":{"url":{"dataType":"string","required":true}}}],"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "GoogleAccountState": {
        "dataType": "refAlias",
        "type": {"dataType":"intersection","subSchemas":[{"ref":"Omit_GoogleAccountEntity.userId-or-accessToken-or-refreshToken-or-expiry_"},{"dataType":"nestedObjectLiteral","nestedProperties":{"mailSearches":{"dataType":"array","array":{"dataType":"refAlias","ref":"GoogleMailSearchState"},"required":true},"loginUrl":{"dataType":"string","required":true}}}],"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    ...
    "Omit_GoogleMailSearchState.id-or-url-or-accountId_": {
        "dataType": "refAlias",
        "type": {"ref":"Pick_GoogleMailSearchState.Exclude_keyofGoogleMailSearchState.id-or-url-or-accountId__","validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "GoogleMailSearchParams": {
        "dataType": "refAlias",
        "type": {"ref":"Omit_GoogleMailSearchState.id-or-url-or-accountId_","validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
export function RegisterRoutes(router: KoaRouter) {
    ...
    // ###########################################################################################################
        router.get('/loginUrl',
            async function MainController_getLoginUrl(context: any, next: any) {
            const args = {
            };
            ...
            const promise = controller.getLoginUrl.apply(controller, validatedArgs as any);
            return promiseHandler(controller, promise, context, undefined, next);
        });
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        router.get('/accounts',
            async function MainController_listAccounts(context: any, next: any) {
            const args = {
            };
        ...
        router.put('/search',
            ...
            const args = {
                    undefined: {"in":"body","required":true,"dataType":"nestedObjectLiteral","nestedProperties":{"params":{"ref":"GoogleMailSearchParams","required":true},"accountId":{"dataType":"string","required":true}}},
            };
        ...
        router.patch('/search',
            ...
            const args = {
                    undefined: {"in":"body","required":true,"dataType":"nestedObjectLiteral","nestedProperties":{"params":{"ref":"Partial_GoogleMailSearchParams_","required":true},"id":{"dataType":"string","required":true}}},
            };
