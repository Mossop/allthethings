...
const mutationResolvers: TypeResolver<MutationResolvers, GraphQLCtx<CoreTransaction>> = {
  createContext: ensureAuthed(async (
    tx: CoreTransaction,
    user: User,
  ...
  editContext: ensureAuthed(async (
    tx: CoreTransaction,
    user: User,
  ...
  deleteContext: ensureAuthed(async (
    tx: CoreTransaction,
    user: User,
  ...
  createProject: ensureAuthed(async (
    tx: CoreTransaction,
    user: User,
  ...
  editProject: ensureAuthed(async (
    tx: CoreTransaction,
    user: User,
  ...
  moveProject: ensureAuthed(async (
    tx: CoreTransaction,
    user: User,
  ...
  deleteProject: ensureAuthed(async (
    tx: CoreTransaction,
    user: User,
  ...
  createSection: ensureAuthed(async (
    tx: CoreTransaction,
    user: User,
    { taskList: taskListId, before: beforeId, params }: MutationCreateSectionArgs,
  ): Promise<Section> => {
    let { stores } = tx;
    let taskList = await TaskListBase.getTaskList(tx, taskListId);
    if (!taskList) {
  ...
  editSection: ensureAuthed(async (
    tx: CoreTransaction,
    user: User,
  ...
  moveSection: ensureAuthed(async (
    tx: CoreTransaction,
    user: User,
  ...
  deleteSection: ensureAuthed(async (
    tx: CoreTransaction,
    user: User,
  ...
  createLink: ensureAuthed(async (
    ...
    let id = await ServiceManager.createItemFromURL(tx.transaction, user.id, targetUrl, isTask);
    if (id) {
  ...
  editTaskInfo: ensureAuthed(async (
    tx: CoreTransaction,
    user: User,
  ...
  editTaskController: ensureAuthed(async (
    tx: CoreTransaction,
    user: User,
    ...
    if (controller != TaskController.Manual) {
      ...
      switch (controller) {
        case TaskController.ServiceList: {
          ...
          taskInfo.due = taskInfo.manualDue ?? await detail.getItemDueForLists();
          break;
        }
  ...
  archiveItem: ensureAuthed(async (
    tx: CoreTransaction,
    user: User,
  ...
  markItemDue: ensureAuthed(async (
    tx: CoreTransaction,
    user: User,
  ...
  changePassword: ensureAuthed(async (
    tx: CoreTransaction,
    user: User,
