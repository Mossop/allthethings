...
export type ServiceDetailKeySpecifier = ('serviceId' | 'hasTaskState' | 'wasEverListed' | 'isCurrentlyListed' | 'fields' | 'lists' | ServiceDetailKeySpecifier)[];
...
export type ServiceListKeySpecifier = ('id' | 'serviceId' | 'name' | 'url' | ServiceListKeySpecifier)[];
...
export type TypedTypePolicies = TypePolicies & {
	...
	ServiceDetail?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | ServiceDetailKeySpecifier | (() => undefined | ServiceDetailKeySpecifier),
		fields?: ServiceDetailFieldPolicy,
	},
	ServiceList?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | ServiceListKeySpecifier | (() => undefined | ServiceListKeySpecifier),
