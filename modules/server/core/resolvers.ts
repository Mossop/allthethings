...
import { FileDetail, LinkDetail, NoteDetail, ServiceDetail } from "./implementations";
import MutationResolvers from "./mutations";
import QueryResolvers from "./queries";
import type { Resolvers } from "./schema";
import type { CoreTransaction } from "./transaction";

export const coreResolvers = rootResolvers<Resolvers, GraphQLCtx<CoreTransaction>>({
  Query: QueryResolvers,
  Mutation: MutationResolvers,

  ItemDetail: {
    __resolveType(obj: ItemDetail): "ServiceDetail" | "LinkDetail" | "NoteDetail" | "FileDetail" {
