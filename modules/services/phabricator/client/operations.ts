...
export type ListPhabricatorAccountsQueryVariables = Schema.Exact<{ [key: string]: never; }>;
...
export type ListPhabricatorQueriesQueryVariables = Schema.Exact<{ [key: string]: never; }>;


export type ListPhabricatorQueriesQuery = { readonly __typename: 'Query', readonly user: Schema.Maybe<{ readonly __typename: 'User', readonly id: string, readonly phabricatorQueries: ReadonlyArray<{ readonly __typename: 'PhabricatorQuery', readonly queryId: string, readonly name: string, readonly description: string }> }> };
...
export type UpdatePhabricatorAccountMutation = { readonly __typename: 'Mutation', readonly updatePhabricatorAccount: Schema.Maybe<{ readonly __typename: 'PhabricatorAccount', readonly id: string, readonly email: string, readonly icon: string, readonly url: string, readonly apiKey: string, readonly enabledQueries: ReadonlyArray<string> }> };
